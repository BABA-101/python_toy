...
for i in range(len(name_list)):
    ...
    run=para.add_run(' 생 년 월 일: ' + birth_list[i] + '\n')
    run.font.name='나눔고딕'
    run._element.rPr.rFonts.set(qn('w:eastAsia'),'나눔고딕')
    run.font.size = docx.shared.Pt(20)
    ...
    doc.save('project-12\\' + name_list[i] + '.docx')
    convert('project-12\\' + name_list[i] + '.docx', 'project-12\\' + name_list[i] + '.pdf')